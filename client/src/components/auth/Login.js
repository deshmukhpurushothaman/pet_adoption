  ...
  componentDidMount() {
    ...
    return (
      <div className='margin'>
        <img className='mobile d-none d-xl-block d-md-block' src={pets} style={{height: "470px", width: "511px"}}/>
        {/* <img className='mobile d-none d-xl-block d-md-block' src={mobile}/> */}
        <div className='d-flex flex-column height'>
          <div className='card'>
            <div className='card-body'>
              <img className='logo' src={logo3} alt='Pet Adoption' style={{height: 100, width: 100}}/>
              <br />
              <br />
